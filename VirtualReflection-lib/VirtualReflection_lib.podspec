Pod::Spec.new do |spec|
    ...
    if !Dir.exist?('build/cocoapods/framework/VirtualReflection.framework') || Dir.empty?('build/cocoapods/framework/VirtualReflection.framework')
        raise "

        Kotlin framework 'VirtualReflection' doesn't exist yet, so a proper Xcode project can't be generated.
        'pod install' should be executed after running ':generateDummyFramework' Gradle task:

            ./gradlew :VirtualReflection-lib:generateDummyFramework
